...
def convert_to_json(i_file, output_wrapper):
    """
    ...
    for dependency_match in ie_compiled.finditer(i_file_string_object):
        ...
        if "affecting installed version" in title_line:
            ...
            dependency_match = title_line.split(" ")[0]
            ...
            vuln_amount = title_line.split(" ")[2]
            ...
            output_wrapper.add(va_stdout_string)
...
def parse(i_file, reporter, output_wrapper):
    json_object = convert_to_json(i_file, output_wrapper) 
